...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_more_than_four(self):
        s = Square(10, 10, 10, 10)
        s.update(id=89, size=2, x=3, y=4, a=12)
        self.assertEqual("[Square] (89) 3/4 - 2", str(s))
    ...
    def test_update_kwargs_None_id_and_more(self):
        s = Square(10, 10, 10, 10)
        s.update(id=None, x=4, y=5)
        correct = "[Square] ({}) 4/5 - 10".format(s.id)
        self.assertEqual(correct, str(s))

    def test_update_kwargs_twice(self):
        s = Square(10, 10, 10, 10)
        s.update(id=89, size=2, x=3, y=4)
        s.update(id=4, x=2, y=89, size=3)
        self.assertEqual("[Square] (4) 2/89 - 3", str(s))
